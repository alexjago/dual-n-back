...
var timeoutNoMatch = false; // default to false
...
function setUpExperiment(){
	...
	/** We don't actually need this, not with all the settings
	  * (and it breaks the tabindex trick)
	**/
	...
	testing_block = {
		...
		modality_choice : modalityChoice,
		prompt: '',
